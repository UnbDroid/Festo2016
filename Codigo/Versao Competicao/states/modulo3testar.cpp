...
Modulo3Testar  *Modulo3Testar::instance()
{
    static Modulo3Testar  Modulo3TestarStateInstance;
    return &Modulo3TestarStateInstance;
}

Modulo3Testar::Modulo3Testar() {}
...
void Modulo3Testar::enter(Robotino *robotino)
{
    std::cout << "Entrando no estado Modulo3Testar...\n";
}
...
void Modulo3Testar::execute(Robotino *robotino)
{
...
void Modulo3Testar::exit(Robotino *robotino) {}
