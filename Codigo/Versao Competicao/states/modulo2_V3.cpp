...
Modulo2_V3  *Modulo2_V3::instance()
{
    static Modulo2_V3  Modulo2_V3StateInstance;
    return &Modulo2_V3StateInstance;
}

Modulo2_V3::Modulo2_V3() {}

Modulo2_V3::~Modulo2_V3() {}

void Modulo2_V3::enter(Robotino *robotino)
{
    //if(!c_Modulo2_V302) throw std::invalid_argument("Modulo2_V3 must have an owner to enter.");
...
int decidirQualAreaIrV3(Robotino * robotino){
...
void Modulo2_V3::execute(Robotino *robotino)
{
...
// Parte que ve os discos e decide onde ir -----------------------------------------------------------------------------------------------------------------------
    ...
    // }
    else if (objetivo_completo == 2121){
        ...
        robotino->setVelocidadeBusca(VELBUSCA);
        ...
        areaIr = decidirQualAreaIrV3(robotino);
        ...
        robotino->setCarregando(false);
        robotino->definirDestino(robotino->odometryX()/10-20, -160);
        robotino->change_state(IrParaPonto::instance());
        if (areaIr == OBJETIVOAREA3){
...
void Modulo2_V3::exit(Robotino *robotino) {
