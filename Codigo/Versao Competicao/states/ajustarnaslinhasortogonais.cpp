...
AjustarNasLinhasOrtogonais  *AjustarNasLinhasOrtogonais::instance()
{
    static AjustarNasLinhasOrtogonais  AjustarNasLinhasOrtogonaisStateInstance;
    return &AjustarNasLinhasOrtogonaisStateInstance;
}

AjustarNasLinhasOrtogonais::AjustarNasLinhasOrtogonais() {}

AjustarNasLinhasOrtogonais::~AjustarNasLinhasOrtogonais() {}

void AjustarNasLinhasOrtogonais::enter(Robotino *robotino)
{
    std::cout << "Entrando no estado AjustarNasLinhasOrtogonais...\n";
}
...
void AjustarNasLinhasOrtogonais::exit(Robotino *robotino) {
    std::cout << "Saindo do estado AjustarNasLinhasOrtogonais...\n";
}
