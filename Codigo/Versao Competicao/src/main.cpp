...
int main( int argc, char **argv )
{
	...
	try{
		...
		//Banana
		Robotino robo(hostname.c_str(), Modulo3::instance(), Coordenadas(371,-141,180));//Coordenadas(173.5,-173.5,90));// Modulo 1 Coordenadas(30,-30,0));// Modulo 3 Coordenadas(173.5,-100,180)); // Modulo 2 Coordenadas(173.5,-173.5,90)); : modulo 2
