...
void ControlarPosicao::execute(Robotino *robotino)
{
    ...
    float w,Vx,Vy,
            erroX          = -(robotino->odometryX()     - robotino->xD),
            erroY          = -(robotino->odometryY()     - robotino->yD),
            erroTheta   = (robotino->odometryPhi()  - robotino->thetaR);
    ...
    std::cout << "Referencia: "<< robotino->xD << "\n";
    std::cout << "Erro: " << erroX << "\n";

    std::cout << "Y: " << robotino->odometryY() << "\n";
    std::cout << "Referencia: "<< robotino->yD << "\n";
    std::cout << "Erro: " << erroY << "\n";
